...
class Faculty_Add_Material extends StatefulWidget {
  const Faculty_Add_Material({Key? key, required this.username})
      : super(key: key);

  final String username;

  @override
  _Faculty_Add_MaterialState createState() => _Faculty_Add_MaterialState();
}

class _Faculty_Add_MaterialState extends State<Faculty_Add_Material> {
